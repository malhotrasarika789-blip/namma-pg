      ...
      <div className="max-w-4xl mx-auto">
        ...
        className="flex justify-between items-center mb-8">
          ...
          <div>
            ...
            <p className="text-zinc-400 mt-2">Register a new complaint</p>
            </div>
            ...
            className="bg-[#18181B] border border-zinc-800 rounded-3xl p-8 space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select name="tenant" value={formData.tenant} onChange={handleChange} className="w-full h-11 rounded-md bg-zinc-900 border border-zinc-700 px-3 text-white">
                    ...
                    {tenants.map((tenant) => ( <option key={tenant._id} value={tenant._id}>
              ...
              <div>
                ...
                <select name="room" value={formData.room} onChange={handleChange} className="w-full h-11 rounded-md bg-zinc-900 border border-zinc-700 px-3 text-white">
                  ...
                  {rooms.map((room) => ( <option key={room._id} value={room._id}>Room {room.roomNumber}</option>
                ))}
              </select>
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <Input name="title" value={formData.title} onChange={handleChange} placeholder="AC not working" className="bg-zinc-900 border-zinc-700 text-white"/>
            </div>
